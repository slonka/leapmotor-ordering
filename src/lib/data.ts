...
export const COLORS: ColorOption[] = [
  { id: 'mint-green', nameKey: 'color.mint-green', hex: '#98d4a8', surcharge: 0 },
  { id: 'caribbean-blue', nameKey: 'color.caribbean-blue', hex: '#6bb8d4', surcharge: 0 },
  { id: 'light-white', nameKey: 'color.light-white', hex: '#f5f5f5', surcharge: 1700 },
  { id: 'canopy-grey', nameKey: 'color.canopy-grey', hex: '#5a5a5a', surcharge: 1700 },
];
