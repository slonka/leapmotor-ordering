...
export default function StepFinancing() {
  ...
  return (
    <div className="animate-fade-in">
      <h2 className="text-2xl font-bold text-gray-900 mb-2">{t('financing.title')}</h2>

      {/* Insurance promo badge */}
      <div className="bg-emerald-50 border border-emerald-200 rounded-lg p-3 mb-6 flex items-center gap-3">
        ...
        <span className="text-sm text-emerald-800 font-medium">{t('financing.insurance')}</span>
      </div>
